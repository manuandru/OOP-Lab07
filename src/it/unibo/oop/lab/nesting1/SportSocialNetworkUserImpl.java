...
public class SportSocialNetworkUserImpl<U extends User> extends SocialNetworkUserImpl<U> {
    ...
    /*
     * Nested static Class that rapresent a Sport
     */
    public static final class Sport {
    	...
    	/**
    	 * @param name that unique rapresent the sport
    	 */
		...
		/**
    	 * @return true if the sports have the same name
    	 */
		...
		/**
		 * @return String rapresentation of the sport
		 */
